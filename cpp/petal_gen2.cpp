...
void petal_gen2::generate_petal (std::vector<petal_turn>* turns, vector3d* perpendicular)
{
	int nu = 10;					// accuracy (turns number)
	double ra = 20;					// long radius
	double rb = 1;					// short radius
	double startangle = 3 * PI / 2;		// starting angle
